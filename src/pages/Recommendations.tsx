      ...
      <div className="recommendation-card">
        ...
        <div className="recommendation-body">
          <p>
            ...
            Sumanth, who worked for us as a software developer at Kajima from
          ...
          <p>
            During their time with us, Sumanth demonstrated strong technical
          ...
          <p>
            💼 "Sumanth also showed exceptional teamwork and communication
          ...
          <p>
            🌟 "I have no doubt that Sumanth will be a valuable addition to any
